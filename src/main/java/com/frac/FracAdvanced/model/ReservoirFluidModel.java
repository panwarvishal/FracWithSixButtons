...
public class ReservoirFluidModel {
		...
		private String wellTypeSelected;
		
		public String getFluidtype() {
			return fluidtype;
		}
		public String getWellTypeSelected() {
			return wellTypeSelected;
		}
		public void setWellTypeSelected(String wellTypeSelected) {
			this.wellTypeSelected = wellTypeSelected;
		}
		...
		public String toString() {
			return "ReservoirFluidModel [id=" + id + ", param=" + param + ", value=" + value + ", fluidtype="
					+ fluidtype + ", wellType=" + wellType + ", wellTypeSelected=" + wellTypeSelected + ", details="
					+ details + "]";
		}
		...
		public ReservoirFluidModel(Integer id, String param, String value, String fluidtype, String wellType,
				String wellTypeSelected, ProjectDetails details) {
			super();
			this.id = id;
			this.param = param;
			this.value = value;
