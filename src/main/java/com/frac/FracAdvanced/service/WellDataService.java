...
public class WellDataService {
	...
	public List<WellDataModel> wellUpdateMethod(String pid2, List<String> list1)
	{
	...
	/*
	 * public List<WellDataModel> wellUpdateMethod(String pid2,String
	 * completionType, String wellType, List<String> list1) {
	 * 
	 * int pid3= Integer.parseInt(pid2);
	 * 
	 * List<WellDataModel> list5= rs.findByProId(pid3);
	 * 
	 * for(int i=0;i<list5.size()-1;i++) { list5.get(i).setWellType(wellType);
	 * list5.get(i).setCompletionType(completionType);
	 * list5.get(i).setValue(list1.get(i)); rs.save(list5.get(i)); }
	 * List<WellDataModel> list4= rs.findByProId(pid3); return list4; }
	 */
}
